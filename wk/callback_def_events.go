...
type TWkURISchemeRequestEvent func(sender IObject, uriSchemeRequest IWkURISchemeRequest)
...
type TWkGetCookiesFinishEvent func(sender IObject, cookieList IWkCookieList, error_ string)
type TWkDeleteCookieFinishEvent func(sender IObject, result bool, error_ string)
type TWkDecidePolicyEvent func(sender IObject, decision IWkPolicyDecision, type_ WebKitPolicyDecisionType) bool
type TWkWebProcessTerminatedEvent func(sender IObject, reason WebKitWebProcessTerminationReason)
type TWkContextMenuEvent func(sender IObject, contextMenu IWkContextMenu, defaultAction WkAction) bool
